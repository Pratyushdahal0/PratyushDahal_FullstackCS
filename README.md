...
CRUD operations for add menu delete, edit and update
Status update preparing and prepared for order tracking
Admin dashboard
Form validation
...
Cart can me improved more by going there and editing by user
